...
var (
	...
	//go:embed testdata/test_config_disable_passthrough.json
	test_config_disable_passthrough []byte
)
...
func TestBucketingFirstMatchingTarget(t *testing.T) {
	for _, testCase := range test_configs {
		t.Run(testCase.description, func(t *testing.T) {

			config, err := newConfig(testCase.configBody, "", "", "")
...
func TestBucketing_RolloutGatesUser(t *testing.T) {
	...
	config, err := newConfig(test_config_disable_passthrough, "", "", "")
	require.NoError(t, err)
...
func TestConfigParsing(t *testing.T) {
	for _, testCase := range test_configs {
		t.Run(testCase.description, func(t *testing.T) {
			...
			err := SetConfig(testCase.configBody, "test", "etag", "rayid", "lastModified")
			require.NoError(t, err)
