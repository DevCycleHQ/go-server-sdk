...
var (
	...
	//go:embed bench-dd/testdata/fixture_small_config.json
	test_config string

	//go:embed bench-dd/testdata/fixture_small_config_special_characters.json
	test_config_special_characters_var string

	//go:embed bench-dd/testdata/fixture_large_config.json
