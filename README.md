...
| UseDebugWASM                 | bool           | Configures the SDK to use a debug WASM binary to generate more detailed error reporting. This should never be enabled in production environments.<br>*Not applicable for Native Bucketing Library.*                             | false      |


## Native Bucketing Library

This SDK also supports a version of the DevCycle bucketing and segmentation logic built natively in Go. This system is designed as a ultra-high performance alternative to the WASM and Cloud bucketing solutions. 
